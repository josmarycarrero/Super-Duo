...
import josmary.footballscores.DatabaseContract;
import josmary.footballscores.R;
import josmary.footballscores.WidgetProvider;
...
public class myFetchService extends IntentService
{
    ...
    private void getData (String timeFrame)
    {
        ...
        try {
            ...
            m_connection.addRequestProperty("X-Auth-Token", getResources().getString(R.string.apicode));
